                ...
                <tbody>
                  <tr>
                    <td class="column_cell font_default" align="center" valign="top">
                      <p><?php printf( __( "Hi there. Your recent order (#%s) on %s has been completed. Your order details are shown below for your reference:", 'woocommerce' ), $order->get_order_number(), get_option( 'blogname' ) ); ?></p>
                    </td><!-- /.column_cell -->
                  </tr>
                </tbody>
              </table><!-- /.column -->
