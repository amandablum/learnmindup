                ...
                <tbody>
                  <tr>
                    <td class="column_cell font_default" align="center" valign="top">
                      <p><?php printf( __( 'You have received an order from %s', 'woocommerce' ), $order->get_formatted_billing_full_name() ); printf( ' (<time datetime="%s">%s</time>).', date_i18n( 'c', strtotime( $order->order_date ) ), date_i18n( wc_date_format(), strtotime( $order->order_date ) ) );  ?></p>
