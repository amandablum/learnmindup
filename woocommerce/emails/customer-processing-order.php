                ...
                <tbody>
                  <tr>
                    <td class="column_cell font_default" align="center" valign="top">
                      <p><?php printf( __( 'Your order (#%s) has been received and is now being processed. Your order details are shown below for your reference:', 'woocommerce' ), $order->get_order_number() ); ?></p>
                    </td><!-- /.column_cell -->
                  </tr>
                </tbody>
              </table><!-- /.column -->
